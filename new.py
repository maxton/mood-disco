...
#IBM_USERNAME = "22e85e08-a132-46ab-923f-3c2192f80e57" # IBM Speech to Text usernames are strings of the form XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX
...
for q in range(0, len(y)):
	print(y[q])
	urllib2.urlopen('http://54.210.194.0/api/addWord?key=098F6BCD4621D373CADE4E832627B4F6&word='+y[q].lower())
